...
echo "by running running the wrap-shell command:"
echo ""
echo "  $DESTINATION_DIR/scripts/wrap-shell"
echo ""
echo "Using the wrap-shell script is recommended, as it will take care of"
